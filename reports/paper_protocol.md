...
Phase 25 ablations are mandatory before paper submission.

Phase 27 multi-asset expansion is conditional. Proceed only if Phase 25/26 shows either:
...
If neither condition holds, write the paper as a crypto-market benchmark and move multi-asset generalization to future work.
