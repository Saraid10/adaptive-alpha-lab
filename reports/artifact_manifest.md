...
| Phase 39 fold-local smoke evidence | `models/crypto20_fold_local_encoder_manifest.csv`, `models/crypto20_fold_local_encoder_coverage.csv`, `models/crypto20_fold_local_encoder_loss.csv`, `models/crypto20_fold_local_experiment_results.csv`, `reports/phase39_fold_local_results.md` | One-fold implementation evidence only; performance interpretation is prohibited |
