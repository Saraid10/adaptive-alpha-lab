...
| Phase 41 bounded improvement protocol | `configs/phase41_bounded_candidates_v1.json`, `src/phase41_bounded_candidates.py`, `models/phase41_candidate_registry.csv`, `models/phase41_selection_rules.csv`, `reports/phase41_bounded_improvement_protocol.md`, `tests/test_phase41_bounded_candidates.py` | Registers probability-calibration and soft-gating candidates with inner-validation-only selection rules; no performance claim and no Phase 40 outer-test tuning |
| Phase 41B inner-validation runner | `src/phase41_inner_validation_candidates.py`, `run_phase41_inner_validation_candidates.ps1`, `run_phase41_inner_validation_candidates.sh`, `tests/test_phase41_inner_validation_candidates.py` | Implements inner-validation-selected probability calibration and soft-gating candidates for the global/classical ladder; one-fold smoke is diagnostic only and full 16-fold run is explicit |
