...
| H7 | The structural regime-learning mechanism transfers beyond BTC/ETH. | Phase 31-35 test a pre-specified Crypto-20 universe structurally. Phase 36 shows `hmm_guided_hmm` improves IC versus global and raw-feature HMM, but does not improve Sharpe or total return versus raw-feature HMM. | Structurally supported, predictively mixed | Discuss structural transfer separately from portfolio-level alpha generalization. |
