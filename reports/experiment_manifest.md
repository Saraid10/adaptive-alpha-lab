...
| 3 | 36 | Crypto-20 downstream alpha retest | Required before any multi-asset predictive claim | `crypto20_walkforward_experiment_results.csv`, `crypto20_alpha_generalization.md` |
